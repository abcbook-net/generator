...
iform.parseFormWithPrefix = function(formId, prefix){
    var source = iform.parseForm(formId);
    var result = new Object();
    for(var jsonInnerKey in source){
        var newKey = "";
        if(prefix == undefined || prefix == null || prefix == ""){
            newKey = jsonInnerKey;
        } else {
            newKey = prefix+"."+jsonInnerKey;
        }
        result[newKey] = source[jsonInnerKey];
    }
    // console.log(result);
    return result;
};
